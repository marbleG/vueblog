    ...
    theme: defaultTheme({
        ...
        sidebar: {
            '/software-engineering/': [
                '',
                { text: '编程与语言功底', link: '编程与语言功底/' },
                { text: '数据结构与算法', link: '数据结构与算法/' },
                { text: '代码质量与重构', link: '代码质量与重构/' },
                { text: '设计模式与 SOLID', link: '设计模式与 SOLID/' },
                { text: '系统设计 / 架构', link: '系统设计/' },
                { text: '测试与质量保障', link: '测试与质量保障/' },
                { text: '调试与问题定位', link: '调试与问题定位/' },
                { text: '工程化 / CI-CD / DevOps', link: '工程化/' },
                { text: '需求与产品思维', link: '需求与产品思维/' },
                { text: '协作与沟通', link: '协作与沟通/' },
                { text: '技术影响力 / 领导力', link: '技术影响力与领导力/' },
            ],
            '/cicd/': [
                '',
                'devops',
