...
每天似乎都有新的工具、新的 MCP、新的模型、新的技能、新的工作流程、新的功能，还有新的社交媒体帖子。这些帖子都是类似“看啊！我用这个奇怪的提示彻底理解了人工智能的原理”这样的内容。
...
我每天都在使用人工智能技术，我发现，其实少即是多。真正重要的并不是我安装什么、配置什么，或者如何操控代理程序来达成某些目标。那些东西虽然有趣，但归根结底，它们都只是些花招罢了。

I see the biggest gains in my productivity from how I use the harness and how well I understand it.  
我发现，我的工作效率提升最大的原因在于我对这种束带的使用方式，以及我对它的理解程度。
...
在这篇文章中，我将向您介绍一个简单的工作流程，通过利用 GitHub Copilot 现有的功能，您可以显著提升使用 AI 的效率。无需使用复杂的提示或其他人所熟知的技巧，只需使用这个简单的流程即可。实际上，这个流程就是您所需要的全部东西——至少大部分情况下是如此。
