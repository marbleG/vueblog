...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>实践：将不同数据存在不同的磁盘中 <img src="`+d+'" alt="img_4.png"> 修改部分 <img src="'+r+'" alt="img_5.png"><img src="'+t+'" alt="img_6.png"> 定制规则 <img src="'+o+'" alt="img_7.png"><img src="'+m+'" alt="img_8.png"></p>',30)])])}const g=n(u,[["render",v]]),k=JSON.parse('{"path":"/store/ceph.html","title":"ceph分布式文件系统","lang":"zh-CN","frontmatter":{"publish":true,"tags":["ceph","存储","已发布"]},"git":{},"filePathRelative":"store/ceph.md"}');export{g as comp,k as data};
