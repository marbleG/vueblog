...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>##服务 <img src="`+i+'" alt="img.png"></p>',12)])])}const r=n(p,[["render",c]]),o=JSON.parse('{"path":"/linux/","title":"linux学习","lang":"zh-CN","frontmatter":{"publish":true,"tags":["linux","已发布"]},"git":{},"filePathRelative":"linux/README.md"}');export{r as comp,o as data};
