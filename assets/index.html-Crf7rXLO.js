...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>架构</p><ol><li>服务 <ol><li>mon 集群所有信息,状态，入口</li><li>mgr 监控，收集所有信息,查询操作</li><li>mds 元数据</li></ol></li><li>osd 磁盘</li><li>pool 存储池 逻辑概念 ，先创建 <ol><li><code>ceph osd pool ls detail</code></li><li>pg: 归置组，看不见，对象名hash计算后存到PG上（crush1），PG根据pool的类型和副本数放到对应的osd( crush2)</li><li>pgp:</li></ol></li><li>rdb 块</li><li>iSCSI（Internet Small Computer System Interface）是一种在IP网络上运行的存储协议，它将SCSI协议封装在TCP/IP协议中，可以通过网络提供块级存储服务。iSCSI架构通常包括以下组件： <ol><li>iSCSI initiator：发起iSCSI请求的主机或设备，它使用iSCSI协议访问iSCSI target上的存储资源。</li><li>iSCSI target：提供存储资源的设备或主机，它使用iSCSI协议响应iSCSI initiator的请求，并将存储资源映射到iSCSI LUN（Logical Unit Number）。</li><li>iSCSI LUN：iSCSI target上的逻辑单元号，它可以是一个物理磁盘、一个分区、一个文件或其他存储资源，由iSCSI target管理并映射给iSCSI initiator。</li><li>iSCSI SAN（Storage Area Network）：使用iSCSI协议连接的存储网络，它可以是一个局域网或广域网，连接多个iSCSI initiator和iSCSI target，并提供共享存储资源。</li><li>iSCSI HBA（Host Bus Adapter）：连接iSCSI initiator和iSCSI SAN的网络适配器或网卡，它可以是专用的iSCSI HBA或使用标准网卡实现。</li><li>iSCSI software initiator：在主机上安装的iSCSI initiator软件，它使用主机的网络适配器或网卡连接到iSCSI SAN，并将iSCSI请求转换为SCSI命令。</li><li>在iSCSI架构中，iSCSI initiator通过网络连接到iSCSI target，并访问iSCSI LUN上的存储资源，就像直接连接到本地存储设备一样。通过iSCSI技术，可以实现存储资源的共享、备份、迁移等功能，提高存储资源的利用率和可靠性。</li></ol></li></ol><p>rados是对象数据的底层存储服务由多个主机组成的存储集群 librados 是rados的api 可以使用java</p><p>ceph通过crush 计算后存储在对应的服务器上</p><p>访问方式 基于librados api提供接口</p><ol><li>cephfs 挂载后访问</li><li>rbd 块，相当于提供的磁盘</li><li>RadosGW</li></ol><p>底层rados</p><ol><li>FileStore BlueStore POSIX</li></ol><p><img src="`+l+'" alt="img.png"></p><p>对象存储</p><ol><li>副本，故障域（osd，host）</li></ol>',20)])])}const m=a(p,[["render",c]]),t=JSON.parse('{"path":"/store/","title":"存储","lang":"zh-CN","frontmatter":{"publish":true,"tags":["ceph","存储","已发布"]},"git":{"updatedTime":1785203748000,"contributors":[{"name":"mabofu","username":"mabofu","email":"1218892028@qq.com","commits":5,"url":"https://github.com/mabofu"},{"name":"marbleG","username":"marbleG","email":"1218892028@qq.com","commits":1,"url":"https://github.com/marbleG"},{"name":"Ma, Bofu","username":"","email":"bfma@linx-info.com","commits":1}],"changelog":[{"hash":"cd3026482dc3b1ff6a1d3cea702000413e4ffbd7","time":1785203748000,"email":"bfma@linx-info.com","author":"Ma, Bofu","message":"feat: 博客新增 AI 一级分类并发布 Copilot 工作流文章"},{"hash":"fc8399437ff0ef441daa5f8684407d9fa48223d9","time":1783169485000,"email":"1218892028@qq.com","author":"mabofu","message":"feat: migrate existing docs articles to vault/Publish/"},{"hash":"e75c7708230f811c5a59b62fdf00ade97fd3d722","time":1675825703000,"email":"1218892028@qq.com","author":"marbleG","message":"add iscsi info"},{"hash":"8be64ec308f433188aaff013bcd11b417430f97f","time":1667405013000,"email":"1218892028@qq.com","author":"mabofu","message":"ceph 快速入门"},{"hash":"4b624320fab012efd798466a419da8dfee80b9e4","time":1667312538000,"email":"1218892028@qq.com","author":"mabofu","message":"image"},{"hash":"465f171706e0dd2fc2c01687e11240492c1dd581","time":1667231963000,"email":"1218892028@qq.com","author":"mabofu","message":"ceph2"},{"hash":"7b8cdb15bd2c237db55a6e36fbff8ad823fa0a8f","time":1667144031000,"email":"1218892028@qq.com","author":"mabofu","message":"ceph"}]},"filePathRelative":"store/README.md"}');export{m as comp,t as data};
